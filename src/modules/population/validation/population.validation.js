...
export const AddPopulationSchema = Joi.object({
    ...
    national_id: Joi.string().trim().pattern(/^[0-9]{14}$/).message('National ID must be a 14-digit number'),
    ...
    status: Joi.string().valid('crime', 'disaster', 'missing', 'acknowledged').required().lowercase(),
