...
import {   AddPopulationnnSchema, AddPopulationnnlQuery, updatePopulationQuery, updatePopulationSchema} from "../validation/population.validation.js";
...
import getTextFileUploadMiddleware from "../../../middlewares/upload.js";import getTextFileUploadMiddleware from "../../../middlewares/upload.js";
const router=Router()
...
router.post('/addpopulationn',authenticate,autherize('technical'),getTextFileUploadMiddleware(),validate(AddPopulationnSchema,AddPopulationnlQuery), asyncHandler(addPopulation));
router.put('/updatePopulationn/:id',authenticate,autherize('admin'),getTextFileUploadMiddleware(),validate(updatePopulationSchema,updatePopulationQuery), asyncHandler(updatePopulation));
router.post('/identificationByDNAA',authenticate,autherize('admin','technical'),getTextFileUploadMiddleware(),asyncHandler(identificationByDNA))
